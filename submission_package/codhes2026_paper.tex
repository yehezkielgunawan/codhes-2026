...
Figure~\ref{fig:readability} presents a side-by-side comparison of Flesch Reading Ease and LLM Readability Index scores across all ten platforms, illustrating the contrast between traditional and machine-perceived readability.

\begin{figure*}[t]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/figure1_readability_comparison.png}
...
Figure~\ref{fig:token} visualizes this platform-by-platform token ratio comparison, showing that individual implementation characteristics strongly influence tokenization efficiency.

\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/figure2_token_comparison.png}
...
Figure~\ref{fig:effect} provides a visual summary of all Cohen's d effect sizes computed in this study, showing that all LLM evaluation dimensions fall within the large-effect zone favoring machine documentation.

\begin{figure*}[t]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/figure5_effect_sizes.png}
...
Figure~\ref{fig:lri-box} displays the distribution of LRI differences (Machine $-$ Human) across the ten platforms, confirming that the positive trend toward machine documentation is robust despite the Vercel outlier.

\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/figure4_lri_difference_boxplot.png}
...
Figure~\ref{fig:fre-clarity} plots this relationship visually, with each platform represented by two points (human in pink, machine in gold), illustrating the orthogonality of human readability and LLM-perceived quality.

\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/figure3_fre_vs_clarity.png}
