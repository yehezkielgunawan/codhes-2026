...
Data collection was performed using a Python CLI tool (readability-python-demo) developed for this study \cite{Textstat2023}. The tool implements the following pipeline:
